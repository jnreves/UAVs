...
MODEL                := ARDroneReplay_V2
MODULES              := ARDroneReplay_V2_data.c ARDroneReplay_V2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := ARDroneReplay_V2.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ARDroneReplay_V2_ref.rsp
...
# additional includes
REQ_INCLUDES += ;F:/UAVs/Labs/Lab2/DevKit_Lab2/DevKit_Lab2;F:/UAVs/Labs/Lab2/DevKit_Lab2/DevKit_Lab2/ARDroneReplay_V2_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
